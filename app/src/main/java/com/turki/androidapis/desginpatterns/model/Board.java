package com.turki.androidapis.desginpatterns.model;

/**
 * The model is the Data + State + Business logic of our Tic-Tac-Toe application.
 * It’s the brains of our application so to speak. It is not tied to the view or controller,
 * and because of this, it is reusable in many contexts.
 *
